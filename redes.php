...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="redes.php">Redes</a></li>
    ...
    <div>
        <img src="img/rdes1.jpeg" alt="" width="100%" height="450px">
    </div>
    <br><br>
                ...
                <div class="card-wrapper col-lg-4 col-md-6 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://www.eleconomista.net/tendencias/Redes-informaticas-de-2020-seran-mas-automatizadas-y-con-seguridad-integrada-20191030-0041.html" target="_blank" class="btn btn-primary">Go somewhere</a>
                        </div>
                    </div>
                </div>
