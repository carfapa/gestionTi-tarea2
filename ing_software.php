...
<head>
    ...
    <title>Infotec/ing_software</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="ing_software.php">Ing software</a></li>
    ...
    <!-- <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">ingeniería de software</li>
    </ol> -->
    <div>
        <img src="img/inge_sofware.jpeg" alt="" width="100%" height="450px">
    </div>
    <br><br>
            ...
            <div class="card-wrapper col-lg-4 col-md-6 col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://evolbit.net/blog/las-10-principales-tendencias-de-desarrollo-de-software-en-el-2021para-2021/" target="_blank" class="btn btn-primary">Go somewhere</a>
                    </div>
                </div>
            </div>
